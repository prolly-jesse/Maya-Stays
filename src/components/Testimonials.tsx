        ...
        <div className="relative">
          ...
          >
            {reviews.map((r, i) => (
              <div
                key={i}
                className="glass rounded-xl p-6 min-w-[280px] sm:min-w-[320px] snap-start flex-shrink-0"
              >
                ...
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-full gold-gradient flex items-center justify-center text-primary-foreground font-bold text-xs">
                    {r.name[0]}
                  </div>
                  <div>
          ...
          <button
            onClick={() => scroll(-1)}
            className="hidden sm:flex absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 w-10 h-10 glass rounded-full items-center justify-center hover:bg-card/80 transition-colors"
          ...
          <button
            onClick={() => scroll(1)}
            className="hidden sm:flex absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 w-10 h-10 glass rounded-full items-center justify-center hover:bg-card/80 transition-colors"
